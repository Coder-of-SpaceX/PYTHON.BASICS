...
# Use while loop in list
T = ["Radha","Krishna","Parvati","Shiv"]
U = 0
while U < len(T):
	print(T[U])
	U += 1
...
print("-" * 50)
List_1 = ["Radha","Radha","Radha","Radha"]
[print(V) for V in List_1]
...
god = ["Laxmi","Parvati","Saraswati","Vishnu","Mahesh","Brahma"]
W = []
for X in god:
	if "a" in X:
		W.append(X)
